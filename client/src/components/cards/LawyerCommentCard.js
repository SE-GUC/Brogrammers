...
import LawyerAddComment from '../buttons/LawyerAddComment'
...
function LawyerCommentCard (props) {
  const { classes } = props
...
console.log(props.id)
  ...
  return (
    <Card className={classes.card}>
      ...
      <CardActions>
        <LawyerAddComment token={props.token} compid={props.compid} ></LawyerAddComment>
      </CardActions>
    </Card>
  )
}

LawyerCommentCard.propTypes = {
  classes: PropTypes.object.isRequired
}

export default withStyles(styles)(LawyerCommentCard)
