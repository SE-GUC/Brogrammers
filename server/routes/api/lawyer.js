    ...
    if (!editableCompanies) {
      ...
      if (req.body.regulationLaw) {
        ...
        if (regulationlaw) {
          ...
          const newSearchTag = new SearchTag({
            tag: updatedcompstatus.regulationLaw,
      ...
      if (req.body.legalCompanyForm) {
        ...
        if (legalForm) {
          ...
          const newSearchTag = new SearchTag({
            tag: updatedcompstatus.legalCompanyForm,
            location: [updatedcompstatus._id]
          })
          var tag = await SearchTag.create(newSearchTag)
      ...
      if (req.body.governerateHQ) {
        ...
        if (governerate) {
          ...
          const newSearchTag = new SearchTag({
            tag: updatedcompstatus.governerateHQ,
            location: [updatedcompstatus._id]
          })
          var tag = await SearchTag.create(newSearchTag)
      ...
      if (req.body.capitalCurrency) {
        ...
        if (currency) {
          ...
          const newSearchTag = new SearchTag({
            tag: updatedcompstatus.capitalCurrency,
            location: [updatedcompstatus._id]
          })
          var tag = await SearchTag.create(newSearchTag)
      ...
      if (req.body.investorEmail) {
        ...
        if (investEmail) {
          ...
          const newSearchTag = new SearchTag({
            tag: updatedcompstatus.investorEmail,
            location: [updatedcompstatus._id]
          })
          var tag = await SearchTag.create(newSearchTag)
